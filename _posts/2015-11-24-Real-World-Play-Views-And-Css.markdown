...
The implicit in this mentions 'notary.css', which means that we have to rename and move main.css to stylesheets/notary.css. It 'feels right' that the notary project should have a 'notary.css' for it, the
